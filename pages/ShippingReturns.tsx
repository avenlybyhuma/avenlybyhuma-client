                ...
                <div className="container mx-auto max-w-6xl">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        <div className="bg-white p-6 rounded-lg text-center shadow-sm">
                            ...
                            <h3 className="font-serif font-medium text-primary mb-2">Free Shipping</h3>
                        ...
                        <div className="bg-white p-6 rounded-lg text-center shadow-sm">
                            ...
                            <h3 className="font-serif font-medium text-primary mb-2">Fast Processing</h3>
                        ...
                        <div className="bg-white p-6 rounded-lg text-center shadow-sm">
                            ...
                            <h3 className="font-serif font-medium text-primary mb-2">30-Day Returns</h3>
                        ...
                        <div className="bg-white p-6 rounded-lg text-center shadow-sm">
                            ...
                            <h3 className="font-serif font-medium text-primary mb-2">Secure Packaging</h3>
                ...
                <div className="container mx-auto max-w-4xl">
                    <div className="space-y-12">
                        ...
                        <div className="bg-white p-8 md:p-12 rounded-lg shadow-sm">
                            <h2 className="text-3xl font-serif text-primary mb-6">Shipping Policy</h2>

                            <div className="space-y-6">
                                <div>
                                    <h3 className="text-xl font-serif text-primary mb-3">Domestic Shipping (US)</h3>
                                ...
                                <div>
                                    <h3 className="text-xl font-serif text-primary mb-3">International Shipping</h3>
                                    <ul className="space-y-2 text-primary/70">
                                ...
                                <div>
                                    <h3 className="text-xl font-serif text-primary mb-3">Order Processing</h3>
                        ...
                        {/* Return Policy */}
                        <div className="bg-white p-8 md:p-12 rounded-lg shadow-sm">
                            <h2 className="text-3xl font-serif text-primary mb-6">Return & Exchange Policy</h2>

                            <div className="space-y-6">
                                <div>
                                    <h3 className="text-xl font-serif text-primary mb-3">30-Day Satisfaction Guarantee</h3>
                                ...
                                <div>
                                    <h3 className="text-xl font-serif text-primary mb-3">How to Return</h3>
                                ...
                                <div>
                                    <h3 className="text-xl font-serif text-primary mb-3">Important Notes</h3>
                                    <ul className="space-y-2 text-primary/70">
                                ...
                                <div className="bg-sage/10 p-6 rounded-lg mt-6">
                                    <h4 className="font-serif font-medium text-primary mb-2">Damaged or Defective Items?</h4>
